...
Route::get('/generos', [SeriesController::class, 'indexGenero']); // Rota para listar todos os gêneros
Route::get('/generos/criar', [SeriesController::class, 'createGenero']); // Rota para adicionar um novo gênero
Route::post('/generos/salvar', [SeriesController::class, 'storeGenero']); // Rota para salvar um novo gênero
Route::get('/generos/{id}/editar', [SeriesController::class, 'editGenero']); // Rota para editar um gênero
Route::put('/generos/{id}', [SeriesController::class, 'updateGenero']); // Rota para atualizar um gênero
Route::delete('/generos/{id}', [SeriesController::class, 'destroyGenero']); // Rota para deletar um gênero
